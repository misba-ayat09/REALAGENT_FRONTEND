...
import Activity from './activities.svg';
import Brand from './brand-setup.svg';
import Poster from './createposter.svg'
import Social_Media from './Social-Media.svg'
...
export const icons: Record<IconType, string> = {
  ...
  [IconType.Publish]: Publish,
  [IconType.Activity]: Activity,
  [IconType.Brand]: Brand,
  [IconType.Poster]: Poster,
  [IconType.Social_Media]: Social_Media,
};
